...
class SequentialNetworkRequestsCallbacksViewModel(
    ...
    // the callbacks will persist even if the user leaves the screen, causes memory leak
    //  (use profiler to view leaks)
    // to avoid override the viewModel onClear method
